...
buttonadd=Button(root,text="+",padx=30,pady=20,command=buttonadd)
buttonsub=Button(root,text="-",padx=30,pady=20,command=sub)
buttonmul=Button(root,text="*",padx=30,pady=20,command=mul)
buttondiv=Button(root,text="/",padx=30,pady=20,command=div)
...
buttonpow=Button(root,text="pow",padx=30,pady=20,command=pow)
buttonquit=Button(root,text="exit",padx=30,pady=20,command=root.quit)
